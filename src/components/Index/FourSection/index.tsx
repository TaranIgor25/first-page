        ...
        <div className={style.fourSectionWrap}>
          <div className={style.fourSectionBlocks}>
            <div className={style.fourSectionHeader}>
              <h2 className={style.h2FourSection}>Build and style every element to perfection</h2>
              <p className={style.pFourSection}>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.</p>
            </div>
            {/* svg Items */}
            ...
            <div className={style.circleMobile}>1</div>
              <div className={`${style.mobileBlock} ${style.imgFirst}`}>
                <img src="./img/iphone-mockup.png" alt="function demonstration" className={style.mobileImg}/>
              </div>
