...
export const FiveSection = () => {
  ...
  const premiumBlocks = premiumBlockArr.map((block) => 
    <div className={`${style.premiumPlan} ${block.borderClass} ${block.animationClass}`}>
    <div className={style.premiumPlanWrap}>
      ...
      <div className={style.description}>— Lorem ipsum dolor amet sit consect adipiscing.</div>
    </div>
    <div className={style.goPremiumBtn}>
      <a href="#" className={`${style.goPremiumLink}  ${block.btnClass}`}>Go Premium</a>
    </div>
  </div>
  );
        ...
        <div className={style.fiveSectionWrap}>
          <div className={style.fiveSectionBlocks}>
            <div className={style.headerFiveSection}>
              <h2 className={style.h2FiveSection}>Start building for free, then add a plan to go live</h2>
              <p className={style.pFiveSection}>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit laborum — semper quis lectus nulla.</p>
            </div>
            <div className={style.contentFiveSection}>
              <div className={style.plansBlock}>
                ...
                <ul className={style.planContent}>
                  {listLi}
                </ul>
              </div>
                {premiumBlocks}
