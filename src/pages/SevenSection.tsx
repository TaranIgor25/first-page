import "../styles/sevenSection.css";
          ...
          <div className="seven-section-blocks">
            ...
            <div className="seven-section-main">
              <div className="color-block color-block-green">
                <svg className="color-block-svg-top" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="color-block-svg-down" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13 11V5.057L22.72 12 13 18.943V13H2v-2h11zm2 4.057L19.28 12 15 8.943v6.114z"></path>
                </svg>
              </div>
